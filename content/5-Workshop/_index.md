...
4. **[AWS Backend Infrastructure Deployment](5.4-Backend-deployment/)**
   ...
   - 5.4.5 [Deploying AWS Lambda](5.4-Backend-deployment/5.4.5-deploying-aws-lambda/)
   - 5.4.6 [Setting up Amazon API Gateway](5.4-Backend-deployment/5.4.6-creating-API-gateway/)
   - 5.4.7 [Integrating API Gateway with the Frontend (AWS Amplify)](5.4-Backend-deployment/5.4.7-integrating-api-gateway-frontend/)
